...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        if not os.path.exists(icon_path):
            # 使用 Base64 编码的图标数据
            server_icon_data = """
            
            """
            import base64
            with open(icon_path, 'wb') as f:
                f.write(base64.b64decode(server_icon_data.strip()))
